...
/*상장종목정보 Request Dto*/
@Getter
public class StockItemInfoRequest extends KrxBaseRequestDto{
    ...
    @Builder
    public StockItemInfoRequest(Integer numOfRows, Integer pageNo, String basDt, String beginBasDt, String endBasDt, String likeBasDt, String likeSrtnCd, String isinCd, String likeIsinCd, String itmsNm, String likeItmsNm, String crno, String corpNm, String likeCorpNm) {
